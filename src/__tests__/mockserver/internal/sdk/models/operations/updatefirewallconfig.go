...
type RequestBodyID string

const (
	RequestBodyIDOwasp RequestBodyID = "owasp"
)

func (e RequestBodyID) ToPointer() *RequestBodyID {
	return &e
}
func (e *RequestBodyID) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "owasp":
		*e = RequestBodyID(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RequestBodyID: %v", v)
	}
}
...
func (o *Eleven) GetID() RequestBodyID {
	if o == nil {
...
// RequestBody10 - Remove an IP Blocking rule
...
func CreateUpdateFirewallConfigRateLimitSecurityActionAny(any any) UpdateFirewallConfigRateLimitSecurityAction {
...
func CreateUpdateFirewallConfigRequestBodyRateLimitAny(any any) UpdateFirewallConfigRequestBodyRateLimit {
...
func CreateUpdateFirewallConfigRequestBodyRedirectAny(any any) UpdateFirewallConfigRequestBodyRedirect {
