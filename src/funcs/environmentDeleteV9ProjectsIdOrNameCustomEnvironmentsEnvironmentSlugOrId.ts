 ...
 */
export async function environmentDeleteV9ProjectsIdOrNameCustomEnvironmentsEnvironmentSlugOrId(
  client: VercelCore,
  request: DeleteV9ProjectsIdOrNameCustomEnvironmentsEnvironmentSlugOrIdRequest,
