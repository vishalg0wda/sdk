...
| `createdFrom`                                                                                      | [models.GetIntegrationLogDrainsCreatedFrom](../models/getintegrationlogdrainscreatedfrom.md)       | :heavy_minus_sign:                                                                                 | Whether the log drain was created by an integration or by a user                                   | integration                                                                                        |
